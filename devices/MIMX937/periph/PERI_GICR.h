 ...
 * @version
 * @date
 * @brief CMSIS Peripheral Access Layer for PERI_GICR
 *
 * CMSIS Peripheral Access Layer for MIMX9375
 */

/* Prevention from multiple including the same memory map */
#if !defined(PERI_GICR_H_)  /* Check if memory map has not been already included */
#define PERI_GICR_H_
