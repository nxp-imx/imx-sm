...
#define SRC_GEN_MISC_CTRL_IMX937_CDC_RDC_CLKOFF_MODE_EN_MASK (0x1U)
#define SRC_GEN_MISC_CTRL_IMX937_CDC_RDC_CLKOFF_MODE_EN_SHIFT (0U)
/*! IMX937_CDC_RDC_CLKOFF_MODE_EN - Enable CDC RDC Clock Off strategy
 *  0b0..CDC RDC Clock Off strategy disabled
 *  0b1..CDC RDC Clock Off strategy enabled
 */
#define SRC_GEN_MISC_CTRL_IMX937_CDC_RDC_CLKOFF_MODE_EN(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_IMX937_CDC_RDC_CLKOFF_MODE_EN_SHIFT)) & SRC_GEN_MISC_CTRL_IMX937_CDC_RDC_CLKOFF_MODE_EN_MASK)
