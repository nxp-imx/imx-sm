...
#define BLK_CTRL_DDRMIX_CHK_FAULT_DIS_ddr_phy_intfc_chk_fault_dis_MASK (0x1U)
#define BLK_CTRL_DDRMIX_CHK_FAULT_DIS_ddr_phy_intfc_chk_fault_dis_SHIFT (0U)
 ...
 */
#define BLK_CTRL_DDRMIX_CHK_FAULT_DIS_ddr_phy_intfc_chk_fault_dis(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_DDRMIX_CHK_FAULT_DIS_ddr_phy_intfc_chk_fault_dis_SHIFT)) & BLK_CTRL_DDRMIX_CHK_FAULT_DIS_ddr_phy_intfc_chk_fault_dis_MASK)
/*! @} */
