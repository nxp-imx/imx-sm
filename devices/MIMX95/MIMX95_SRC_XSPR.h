...
/*!
 * @file MIMX95_SRC_XSPR.h
 * @version 0.0
 * @date 0-00-00
 * @brief CMSIS Peripheral Access Layer for MIMX95_SRC_XSPR
 *
 * CMSIS Peripheral Access Layer for MIMX95
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX95_SRC_XSPR_H_)  /* Check if memory map has not been already included */
#define MIMX95_SRC_XSPR_H_
...
typedef struct {
  ...
  __I  uint32_t RSTR_STAT;                         /**< reset region status, offset: 0xB8 */
} SRC_XSPR_Type;
...
#define SRC_XSPR_SLICE_SW_CTRL_PSW_CTRL_SOFT_MASK (0x10U)
#define SRC_XSPR_SLICE_SW_CTRL_PSW_CTRL_SOFT_SHIFT (4U)
 ...
 */
#define SRC_XSPR_SLICE_SW_CTRL_PSW_CTRL_SOFT(x)  (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_SLICE_SW_CTRL_PSW_CTRL_SOFT_SHIFT)) & SRC_XSPR_SLICE_SW_CTRL_PSW_CTRL_SOFT_MASK)

#define SRC_XSPR_SLICE_SW_CTRL_MTR_LOAD_SOFT_MASK (0x40U)
#define SRC_XSPR_SLICE_SW_CTRL_MTR_LOAD_SOFT_SHIFT (6U)
/*! MTR_LOAD_SOFT - Software control MTR repair load. Locked by LPM_MODE field.
 *  0b0..No effect
 *  0b1..Software load MTR repair
 */
#define SRC_XSPR_SLICE_SW_CTRL_MTR_LOAD_SOFT(x)  (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_SLICE_SW_CTRL_MTR_LOAD_SOFT_SHIFT)) & SRC_XSPR_SLICE_SW_CTRL_MTR_LOAD_SOFT_MASK)

#define SRC_XSPR_SLICE_SW_CTRL_SSAR_CTRL_SOFT_MASK (0x100U)
#define SRC_XSPR_SLICE_SW_CTRL_SSAR_CTRL_SOFT_SHIFT (8U)
 ...
 */
#define SRC_XSPR_SLICE_SW_CTRL_SSAR_CTRL_SOFT(x) (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_SLICE_SW_CTRL_SSAR_CTRL_SOFT_SHIFT)) & SRC_XSPR_SLICE_SW_CTRL_SSAR_CTRL_SOFT_MASK)

#define SRC_XSPR_SLICE_SW_CTRL_A55_HDSK_CTRL_SOFT_MASK (0x400U)
#define SRC_XSPR_SLICE_SW_CTRL_A55_HDSK_CTRL_SOFT_SHIFT (10U)
 ...
 */
#define SRC_XSPR_SLICE_SW_CTRL_A55_HDSK_CTRL_SOFT(x) (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_SLICE_SW_CTRL_A55_HDSK_CTRL_SOFT_SHIFT)) & SRC_XSPR_SLICE_SW_CTRL_A55_HDSK_CTRL_SOFT_MASK)

#define SRC_XSPR_SLICE_SW_CTRL_SYSMAN_CTRL_SOFT_MASK (0x1000U)
#define SRC_XSPR_SLICE_SW_CTRL_SYSMAN_CTRL_SOFT_SHIFT (12U)
/*! SYSMAN_CTRL_SOFT - Software System manager handshake control. Locked by LPM_MODE field.
 *  0b0..No effect or software notify System manager power up info
 *  0b1..Software notifySystem manager power down info
 */
#define SRC_XSPR_SLICE_SW_CTRL_SYSMAN_CTRL_SOFT(x) (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_SLICE_SW_CTRL_SYSMAN_CTRL_SOFT_SHIFT)) & SRC_XSPR_SLICE_SW_CTRL_SYSMAN_CTRL_SOFT_MASK)

#define SRC_XSPR_SLICE_SW_CTRL_MEM_PGEN_ACK_SW_OVERRIDE_MASK (0x4000U)
#define SRC_XSPR_SLICE_SW_CTRL_MEM_PGEN_ACK_SW_OVERRIDE_SHIFT (14U)
/*! MEM_PGEN_ACK_SW_OVERRIDE - Software Override for Memory acknowledge signal "PRDYN"
 *  0b0..No effect. HW will wait for "PRDYN" ack from memory for Memory Retention Entry/Exit
 *  0b1..HW will NOT wait for "PRDYN" ack from memory for Memory Retention Entry/Exit
 */
#define SRC_XSPR_SLICE_SW_CTRL_MEM_PGEN_ACK_SW_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_SLICE_SW_CTRL_MEM_PGEN_ACK_SW_OVERRIDE_SHIFT)) & SRC_XSPR_SLICE_SW_CTRL_MEM_PGEN_ACK_SW_OVERRIDE_MASK)

#define SRC_XSPR_SLICE_SW_CTRL_SAFE_RESET_MASK   (0xF0000U)
#define SRC_XSPR_SLICE_SW_CTRL_SAFE_RESET_SHIFT  (16U)
/*! SAFE_RESET - Only for CM33 safe reset feature */
#define SRC_XSPR_SLICE_SW_CTRL_SAFE_RESET(x)     (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_SLICE_SW_CTRL_SAFE_RESET_SHIFT)) & SRC_XSPR_SLICE_SW_CTRL_SAFE_RESET_MASK)

#define SRC_XSPR_SLICE_SW_CTRL_RST_RSTR_0_MASK   (0x100000U)
#define SRC_XSPR_SLICE_SW_CTRL_RST_RSTR_0_SHIFT  (20U)
/*! RST_RSTR_0 - Reset Control for Reset Region 0. Locked by LPM_MODE field.
...
/*! RST_RSTR_1 - Reset Control for Reset Region 1. Locked by LPM_MODE field.
...
/*! RST_RSTR_2 - Reset Control for Reset Region 2. Locked by LPM_MODE field.
...
/*! RST_RSTR_3 - Reset Control for Reset Region 3. Locked by LPM_MODE field.
...
/*! ISO_CTRL_0 - Isolation control for IP 0. Locked by LPM_MODE field.
...
/*! ISO_CTRL_1 - Isolation control for IP 1. Locked by LPM_MODE field.
...
/*! ISO_CTRL_2 - Isolation control for IP 2. Locked by LPM_MODE field.
...
/*! ISO_CTRL_3 - Isolation control for IP 3. Locked by LPM_MODE field.
...
/*! ISO_CTRL_4 - Isolation control for IP 4. Locked by LPM_MODE field.
...
/*! ISO_CTRL_5 - Isolation control for IP 5. Locked by LPM_MODE field.
...
/*! ISO_CTRL_6 - Isolation control control for IP 6. Locked by LPM_MODE field.
 *  0b0..disable isolation control of IP 6
...
/** Peripheral SRC_XSPR_CORTEXMIX_CORE4 base address */
#define SRC_XSPR_CORTEXMIX_CORE4_BASE (0x44462800u)
/** Peripheral SRC_XSPR_CORTEXMIX_CORE4 base pointer */
#define SRC_XSPR_CORTEXMIX_CORE4     ((SRC_XSPR_Type *)SRC_XSPR_CORTEXMIX_CORE4_BASE)
/** Peripheral SRC_XSPR_CORTEXMIX_CORE5 base address */
#define SRC_XSPR_CORTEXMIX_CORE5_BASE (0x44462C00u)
/** Peripheral SRC_XSPR_CORTEXMIX_CORE5 base pointer */
#define SRC_XSPR_CORTEXMIX_CORE5     ((SRC_XSPR_Type *)SRC_XSPR_CORTEXMIX_CORE5_BASE)
/** Peripheral SRC_XSPR_CORTEXMIX_PLATFORM base address */
#define SRC_XSPR_CORTEXMIX_PLATFORM_BASE (0x44463000u)
...
#define SRC_XSPR_DDRMIX_BASE         (0x44463400u)
...
#define SRC_XSPR_DISPLAYMIX_BASE     (0x44463800u)
...
#define SRC_XSPR_GPUMIX_BASE         (0x44463C00u)
...
#define SRC_XSPR_HSIOMIX_TOP_BASE    (0x44464000u)
...
#define SRC_XSPR_HSIOMIX_WAON_BASE   (0x44464400u)
...
#define SRC_XSPR_M7MIX_BASE          (0x44464800u)
...
#define SRC_XSPR_NETCMIX_BASE        (0x44464C00u)
...
#define SRC_XSPR_NOCMIX_BASE         (0x44465000u)
...
#define SRC_XSPR_NPUMIX_BASE         (0x44465400u)
...
#define SRC_XSPR_VPUMIX_BASE         (0x44465800u)
...
#define SRC_XSPR_WAKEUPMIX_BASE      (0x44465C00u)
