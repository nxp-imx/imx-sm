 ...
 * @version 0.0
 * @date 0-00-00
 * @brief CMSIS Peripheral Access Layer for MIMX95_TMPSNS
 *
 * CMSIS Peripheral Access Layer for MIMX95
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX95_TMPSNS_H_)  /* Check if memory map has not been already included */
#define MIMX95_TMPSNS_H_
...
typedef struct {
  ...
  __IO uint32_t REF_DIV;                           /**< Ref Clock Divider Control, offset: 0x280 */
  ...
  __I  uint32_t DBG_DATA;                          /**< Debug Data, offset: 0x2C0 */
  __I  uint32_t DBG_DATA_SET;                      /**< Debug Data, offset: 0x2C4 */
  __I  uint32_t DBG_DATA_CLR;                      /**< Debug Data, offset: 0x2C8 */
  __I  uint32_t DBG_DATA_TOG;                      /**< Debug Data, offset: 0x2CC */
 ...
 *  0b10..Temperature data transition is from high to low at threshold
 *  0b11..Temperature data transition is from low to high at threshold
 */
...
/*! FILT0_CNT_CLR - Filter0 Counter Clear
 *  0b0..Settles to 0 after clearing the counter
...
/*! FILT1_CNT_CLR - Filter1 Counter Clear
 *  0b0..Settles to 0 after clearing the counter
 *  0b1..Clear the internal counter
 */
...
/*! FILT2_CNT_CLR - Filter2 Counter Clear
 *  0b0..Settles to 0 after clearing the counter
 *  0b1..Clear the internal counter
 */
 ...
 *  0b00..Less than or equal to threshold
 *  0b01..Greater than threshold
 *  0b10..Temperature data transition is from high to low at the threshold
 *  0b11..Temperature data transition is from low to high at the threshold
 */
...
#define TMPSNS_CTRL1_DBG_DRDY_IE_MASK            (0x20000U)
#define TMPSNS_CTRL1_DBG_DRDY_IE_SHIFT           (17U)
/*! DBG_DRDY_IE - Debug ADCOUT Data-Ready Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define TMPSNS_CTRL1_DBG_DRDY_IE(x)              (((uint32_t)(((uint32_t)(x)) << TMPSNS_CTRL1_DBG_DRDY_IE_SHIFT)) & TMPSNS_CTRL1_DBG_DRDY_IE_MASK)
...
/*! FILT4_CNT_CLR - Filter4 Counter Clear
 *  0b0..Settles to 0 after clearing the counter
 *  0b1..Clear the internal counter
 */
...
/*! FILT5_CNT_CLR - Filter5 Counter Clear
 *  0b0..Settles to 0 after clearing the counter
 *  0b1..Clear the internal counter
 */
 ...
 *  0b0..Cleared by the HW after conversion is stopped.
 *  0b1..Stops the conversion.
 */
...
#define TMPSNS_CTRL1_SET_DBG_DRDY_IE_MASK        (0x20000U)
#define TMPSNS_CTRL1_SET_DBG_DRDY_IE_SHIFT       (17U)
/*! DBG_DRDY_IE - Debug ADCOUT Data-Ready Interrupt Enable */
#define TMPSNS_CTRL1_SET_DBG_DRDY_IE(x)          (((uint32_t)(((uint32_t)(x)) << TMPSNS_CTRL1_SET_DBG_DRDY_IE_SHIFT)) & TMPSNS_CTRL1_SET_DBG_DRDY_IE_MASK)
...
#define TMPSNS_CTRL1_CLR_DBG_DRDY_IE_MASK        (0x20000U)
#define TMPSNS_CTRL1_CLR_DBG_DRDY_IE_SHIFT       (17U)
/*! DBG_DRDY_IE - Debug ADCOUT Data-Ready Interrupt Enable */
#define TMPSNS_CTRL1_CLR_DBG_DRDY_IE(x)          (((uint32_t)(((uint32_t)(x)) << TMPSNS_CTRL1_CLR_DBG_DRDY_IE_SHIFT)) & TMPSNS_CTRL1_CLR_DBG_DRDY_IE_MASK)
...
#define TMPSNS_CTRL1_TOG_DBG_DRDY_IE_MASK        (0x20000U)
#define TMPSNS_CTRL1_TOG_DBG_DRDY_IE_SHIFT       (17U)
/*! DBG_DRDY_IE - Debug ADCOUT Data-Ready Interrupt Enable */
#define TMPSNS_CTRL1_TOG_DBG_DRDY_IE(x)          (((uint32_t)(((uint32_t)(x)) << TMPSNS_CTRL1_TOG_DBG_DRDY_IE_SHIFT)) & TMPSNS_CTRL1_TOG_DBG_DRDY_IE_MASK)
...
#define TMPSNS_STAT1_DBG_DRDY_IF_MASK            (0x20000U)
#define TMPSNS_STAT1_DBG_DRDY_IF_SHIFT           (17U)
/*! DBG_DRDY_IF - Debug ADCOUT Data Valid Flag
 *  0b0..No new data
 *  0b1..New data
 */
#define TMPSNS_STAT1_DBG_DRDY_IF(x)              (((uint32_t)(((uint32_t)(x)) << TMPSNS_STAT1_DBG_DRDY_IF_SHIFT)) & TMPSNS_STAT1_DBG_DRDY_IF_MASK)
...
#define TMPSNS_STAT1_SET_DBG_DRDY_IF_MASK        (0x20000U)
#define TMPSNS_STAT1_SET_DBG_DRDY_IF_SHIFT       (17U)
/*! DBG_DRDY_IF - Debug ADCOUT Data Valid Flag */
#define TMPSNS_STAT1_SET_DBG_DRDY_IF(x)          (((uint32_t)(((uint32_t)(x)) << TMPSNS_STAT1_SET_DBG_DRDY_IF_SHIFT)) & TMPSNS_STAT1_SET_DBG_DRDY_IF_MASK)
...
#define TMPSNS_STAT1_CLR_DBG_DRDY_IF_MASK        (0x20000U)
#define TMPSNS_STAT1_CLR_DBG_DRDY_IF_SHIFT       (17U)
/*! DBG_DRDY_IF - Debug ADCOUT Data Valid Flag */
#define TMPSNS_STAT1_CLR_DBG_DRDY_IF(x)          (((uint32_t)(((uint32_t)(x)) << TMPSNS_STAT1_CLR_DBG_DRDY_IF_SHIFT)) & TMPSNS_STAT1_CLR_DBG_DRDY_IF_MASK)
...
#define TMPSNS_STAT1_TOG_DBG_DRDY_IF_MASK        (0x20000U)
#define TMPSNS_STAT1_TOG_DBG_DRDY_IF_SHIFT       (17U)
/*! DBG_DRDY_IF - Debug ADCOUT Data Valid Flag */
#define TMPSNS_STAT1_TOG_DBG_DRDY_IF(x)          (((uint32_t)(((uint32_t)(x)) << TMPSNS_STAT1_TOG_DBG_DRDY_IF_SHIFT)) & TMPSNS_STAT1_TOG_DBG_DRDY_IF_MASK)
...
/*! @name REF_DIV - Ref Clock Divider Control */
/*! @{ */

#define TMPSNS_REF_DIV_DIV_MASK                  (0xFF0000U)
#define TMPSNS_REF_DIV_DIV_SHIFT                 (16U)
/*! DIV - Divider Value
 *  0b00000000..Output clock frequency is equal to input clock frequency
 *  0b00000001..Output clock frequency is equal to input clock frequency divided by 2
 *  0b00000010..Output clock frequency is equal to input clock frequency divided by 3
 *  0b00000011....
 *  0b11111111..Output clock frequency is equal to input clock frequency divided by 256
 */
...
#define TMPSNS_PUD_ST_CTRL_MODE_SELFTEST_MASK    (0x3U)
#define TMPSNS_PUD_ST_CTRL_MODE_SELFTEST_SHIFT   (0U)
/*! MODE_SELFTEST - Self-Test Mode
 *  0b00..Normal temperature conversion mode
 *  0b01..BJT Core BIST mode
 *  0b10..ADC BIST mode
 *  0b11..ADC BIST mode
 */
#define TMPSNS_PUD_ST_CTRL_MODE_SELFTEST(x)      (((uint32_t)(((uint32_t)(x)) << TMPSNS_PUD_ST_CTRL_MODE_SELFTEST_SHIFT)) & TMPSNS_PUD_ST_CTRL_MODE_SELFTEST_MASK)

#define TMPSNS_PUD_ST_CTRL_SELADCOUT_MASK        (0x30U)
#define TMPSNS_PUD_ST_CTRL_SELADCOUT_SHIFT       (4U)
/*! SELADCOUT - Debug ADC Output Selection
 *  0b00..ADC output
 *  0b01..ADC output first half of conversion
 *  0b10..ADC output second half of conversion
 *  0b11..Internal register indicating reciprocal of ADC output
 */
#define TMPSNS_PUD_ST_CTRL_SELADCOUT(x)          (((uint32_t)(((uint32_t)(x)) << TMPSNS_PUD_ST_CTRL_SELADCOUT_SHIFT)) & TMPSNS_PUD_ST_CTRL_SELADCOUT_MASK)
...
#define TMPSNS_PUD_ST_CTRL_SET_MODE_SELFTEST_MASK (0x3U)
#define TMPSNS_PUD_ST_CTRL_SET_MODE_SELFTEST_SHIFT (0U)
/*! MODE_SELFTEST - Self-Test Mode */
#define TMPSNS_PUD_ST_CTRL_SET_MODE_SELFTEST(x)  (((uint32_t)(((uint32_t)(x)) << TMPSNS_PUD_ST_CTRL_SET_MODE_SELFTEST_SHIFT)) & TMPSNS_PUD_ST_CTRL_SET_MODE_SELFTEST_MASK)

#define TMPSNS_PUD_ST_CTRL_SET_SELADCOUT_MASK    (0x30U)
#define TMPSNS_PUD_ST_CTRL_SET_SELADCOUT_SHIFT   (4U)
/*! SELADCOUT - Debug ADC Output Selection */
#define TMPSNS_PUD_ST_CTRL_SET_SELADCOUT(x)      (((uint32_t)(((uint32_t)(x)) << TMPSNS_PUD_ST_CTRL_SET_SELADCOUT_SHIFT)) & TMPSNS_PUD_ST_CTRL_SET_SELADCOUT_MASK)
...
#define TMPSNS_PUD_ST_CTRL_CLR_MODE_SELFTEST_MASK (0x3U)
#define TMPSNS_PUD_ST_CTRL_CLR_MODE_SELFTEST_SHIFT (0U)
/*! MODE_SELFTEST - Self-Test Mode */
#define TMPSNS_PUD_ST_CTRL_CLR_MODE_SELFTEST(x)  (((uint32_t)(((uint32_t)(x)) << TMPSNS_PUD_ST_CTRL_CLR_MODE_SELFTEST_SHIFT)) & TMPSNS_PUD_ST_CTRL_CLR_MODE_SELFTEST_MASK)

#define TMPSNS_PUD_ST_CTRL_CLR_SELADCOUT_MASK    (0x30U)
#define TMPSNS_PUD_ST_CTRL_CLR_SELADCOUT_SHIFT   (4U)
/*! SELADCOUT - Debug ADC Output Selection */
#define TMPSNS_PUD_ST_CTRL_CLR_SELADCOUT(x)      (((uint32_t)(((uint32_t)(x)) << TMPSNS_PUD_ST_CTRL_CLR_SELADCOUT_SHIFT)) & TMPSNS_PUD_ST_CTRL_CLR_SELADCOUT_MASK)
...
#define TMPSNS_PUD_ST_CTRL_TOG_MODE_SELFTEST_MASK (0x3U)
#define TMPSNS_PUD_ST_CTRL_TOG_MODE_SELFTEST_SHIFT (0U)
/*! MODE_SELFTEST - Self-Test Mode */
#define TMPSNS_PUD_ST_CTRL_TOG_MODE_SELFTEST(x)  (((uint32_t)(((uint32_t)(x)) << TMPSNS_PUD_ST_CTRL_TOG_MODE_SELFTEST_SHIFT)) & TMPSNS_PUD_ST_CTRL_TOG_MODE_SELFTEST_MASK)

#define TMPSNS_PUD_ST_CTRL_TOG_SELADCOUT_MASK    (0x30U)
#define TMPSNS_PUD_ST_CTRL_TOG_SELADCOUT_SHIFT   (4U)
/*! SELADCOUT - Debug ADC Output Selection */
#define TMPSNS_PUD_ST_CTRL_TOG_SELADCOUT(x)      (((uint32_t)(((uint32_t)(x)) << TMPSNS_PUD_ST_CTRL_TOG_SELADCOUT_SHIFT)) & TMPSNS_PUD_ST_CTRL_TOG_SELADCOUT_MASK)
...
/*! @name DBG_DATA - Debug Data */
/*! @{ */

#define TMPSNS_DBG_DATA_DBG_ADCOUT_MASK          (0xFFFFU)
#define TMPSNS_DBG_DATA_DBG_ADCOUT_SHIFT         (0U)
/*! DBG_ADCOUT - ADC Debug Data */
#define TMPSNS_DBG_DATA_DBG_ADCOUT(x)            (((uint32_t)(((uint32_t)(x)) << TMPSNS_DBG_DATA_DBG_ADCOUT_SHIFT)) & TMPSNS_DBG_DATA_DBG_ADCOUT_MASK)
/*! @} */

/*! @name DBG_DATA_SET - Debug Data */
/*! @{ */

#define TMPSNS_DBG_DATA_SET_DBG_ADCOUT_MASK      (0xFFFFU)
#define TMPSNS_DBG_DATA_SET_DBG_ADCOUT_SHIFT     (0U)
/*! DBG_ADCOUT - ADC Debug Data */
#define TMPSNS_DBG_DATA_SET_DBG_ADCOUT(x)        (((uint32_t)(((uint32_t)(x)) << TMPSNS_DBG_DATA_SET_DBG_ADCOUT_SHIFT)) & TMPSNS_DBG_DATA_SET_DBG_ADCOUT_MASK)
/*! @} */

/*! @name DBG_DATA_CLR - Debug Data */
/*! @{ */

#define TMPSNS_DBG_DATA_CLR_DBG_ADCOUT_MASK      (0xFFFFU)
#define TMPSNS_DBG_DATA_CLR_DBG_ADCOUT_SHIFT     (0U)
/*! DBG_ADCOUT - ADC Debug Data */
#define TMPSNS_DBG_DATA_CLR_DBG_ADCOUT(x)        (((uint32_t)(((uint32_t)(x)) << TMPSNS_DBG_DATA_CLR_DBG_ADCOUT_SHIFT)) & TMPSNS_DBG_DATA_CLR_DBG_ADCOUT_MASK)
/*! @} */

/*! @name DBG_DATA_TOG - Debug Data */
/*! @{ */

#define TMPSNS_DBG_DATA_TOG_DBG_ADCOUT_MASK      (0xFFFFU)
#define TMPSNS_DBG_DATA_TOG_DBG_ADCOUT_SHIFT     (0U)
/*! DBG_ADCOUT - ADC Debug Data */
#define TMPSNS_DBG_DATA_TOG_DBG_ADCOUT(x)        (((uint32_t)(((uint32_t)(x)) << TMPSNS_DBG_DATA_TOG_DBG_ADCOUT_SHIFT)) & TMPSNS_DBG_DATA_TOG_DBG_ADCOUT_MASK)
/*! @} */
...
/* TMPSNS - Peripheral instance base addresses */
  ...
  /** Peripheral ANALOG__TMPSNS base address */
  #define ANALOG__TMPSNS_BASE                      (0x54482000u)
  /** Peripheral ANALOG__TMPSNS base address */
  #define ANALOG__TMPSNS_BASE_NS                   (0x44482000u)
  /** Peripheral ANALOG__TMPSNS base pointer */
  #define ANALOG__TMPSNS                           ((TMPSNS_Type *)ANALOG__TMPSNS_BASE)
  /** Peripheral ANALOG__TMPSNS base pointer */
  #define ANALOG__TMPSNS_NS                        ((TMPSNS_Type *)ANALOG__TMPSNS_BASE_NS)
  ...
  #define TMPSNS_BASE_ADDRS                        { ANALOG__TMPSNS_BASE, CORTEXA__TMPSNS_BASE }
  /** Array initializer of TMPSNS peripheral base pointers */
  #define TMPSNS_BASE_PTRS                         { ANALOG__TMPSNS, CORTEXA__TMPSNS }
  /** Array initializer of TMPSNS peripheral base addresses */
  #define TMPSNS_BASE_ADDRS_NS                     { ANALOG__TMPSNS_BASE_NS, CORTEXA__TMPSNS_BASE_NS }
  /** Array initializer of TMPSNS peripheral base pointers */
  #define TMPSNS_BASE_PTRS_NS                      { ANALOG__TMPSNS_NS, CORTEXA__TMPSNS_NS }
#else
  /** Peripheral ANALOG__TMPSNS base address */
  #define ANALOG__TMPSNS_BASE                      (0x44482000u)
  /** Peripheral ANALOG__TMPSNS base pointer */
  #define ANALOG__TMPSNS                           ((TMPSNS_Type *)ANALOG__TMPSNS_BASE)
  /** Peripheral CORTEXA__TMPSNS base address */
...
#endif  /* #if !defined(MIMX95_TMPSNS_H_) */
