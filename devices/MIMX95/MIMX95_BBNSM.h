 ...
 * @version 1.0
 * @date 2021-11-16
 * @brief CMSIS Peripheral Access Layer for MIMX95_BBNSM
 *
 * CMSIS Peripheral Access Layer for MIMX95
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX95_BBNSM_H_)  /* Check if memory map has not been already included */
#define MIMX95_BBNSM_H_
...
typedef struct
{
    ...
    __IO uint32_t GPR[8]; /**< General Purpose Register Word 0..General Purpose Register Word 7, array offset: 0x300,
                             array step: 0x4 */
} BBNSM_Type;
 ...
 */
#define BBNSM_BBNSM_VID_BBNSM_IPID(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_VID_BBNSM_IPID_SHIFT)) & BBNSM_BBNSM_VID_BBNSM_IPID_MASK)

#define BBNSM_BBNSM_VID_BBNSM_REV_MASK  (0xFF00U)
#define BBNSM_BBNSM_VID_BBNSM_REV_SHIFT (8U)
/*! BBNSM_REV - BBNSM Revision
 */
#define BBNSM_BBNSM_VID_BBNSM_REV(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_VID_BBNSM_REV_SHIFT)) & BBNSM_BBNSM_VID_BBNSM_REV_MASK)

#define BBNSM_BBNSM_VID_BBNSM_VID_MASK  (0xFF0000U)
#define BBNSM_BBNSM_VID_BBNSM_VID_SHIFT (16U)
/*! BBNSM_VID - BBNSM Version ID
 */
#define BBNSM_BBNSM_VID_BBNSM_VID(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_VID_BBNSM_VID_SHIFT)) & BBNSM_BBNSM_VID_BBNSM_VID_MASK)
/*! @} */
...
#define BBNSM_BBNSM_FEATURES_GPR_SZ(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_FEATURES_GPR_SZ_SHIFT)) & BBNSM_BBNSM_FEATURES_GPR_SZ_MASK)
/*! @} */
 ...
 */
#define BBNSM_BBNSM_CTRL_RTC_EN(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_RTC_EN_SHIFT)) & BBNSM_BBNSM_CTRL_RTC_EN_MASK)
 ...
 */
#define BBNSM_BBNSM_CTRL_TA_EN(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_TA_EN_SHIFT)) & BBNSM_BBNSM_CTRL_TA_EN_MASK)
 ...
 */
#define BBNSM_BBNSM_CTRL_CAL_EN(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_CAL_EN_SHIFT)) & BBNSM_BBNSM_CTRL_CAL_EN_MASK)
 ...
 */
#define BBNSM_BBNSM_CTRL_CAL_VAL(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_CAL_VAL_SHIFT)) & BBNSM_BBNSM_CTRL_CAL_VAL_MASK)
 ...
 */
#define BBNSM_BBNSM_CTRL_BTN_TIMEOUT(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_BTN_TIMEOUT_SHIFT)) & BBNSM_BBNSM_CTRL_BTN_TIMEOUT_MASK)
 ...
 *  0b11..0 milliseconds.
 */
#define BBNSM_BBNSM_CTRL_DEBOUNCE(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_DEBOUNCE_SHIFT)) & BBNSM_BBNSM_CTRL_DEBOUNCE_MASK)
 ...
 *  0b11..0 milliseconds.
 */
#define BBNSM_BBNSM_CTRL_TURN_ON_TIME(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_TURN_ON_TIME_SHIFT)) & BBNSM_BBNSM_CTRL_TURN_ON_TIME_MASK)

#define BBNSM_BBNSM_CTRL_PK_EN_MASK  (0x400000U)
#define BBNSM_BBNSM_CTRL_PK_EN_SHIFT (22U)
/*! PK_EN - PMIC On Request Enable
 */
#define BBNSM_BBNSM_CTRL_PK_EN(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_PK_EN_SHIFT)) & BBNSM_BBNSM_CTRL_PK_EN_MASK)

#define BBNSM_BBNSM_CTRL_PK_OVR_MASK  (0x800000U)
#define BBNSM_BBNSM_CTRL_PK_OVR_SHIFT (23U)
/*! PK_OVR - PMIC On Request Override
 */
#define BBNSM_BBNSM_CTRL_PK_OVR(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_PK_OVR_SHIFT)) & BBNSM_BBNSM_CTRL_PK_OVR_MASK)
 ...
 */
#define BBNSM_BBNSM_CTRL_DP_EN(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_DP_EN_SHIFT)) & BBNSM_BBNSM_CTRL_DP_EN_MASK)
 ...
 */
#define BBNSM_BBNSM_CTRL_TOSP(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_CTRL_TOSP_SHIFT)) & BBNSM_BBNSM_CTRL_TOSP_MASK)
/*! @} */
 ...
 */
#define BBNSM_BBNSM_INT_EN_RTC_INT_EN(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_INT_EN_RTC_INT_EN_SHIFT)) & BBNSM_BBNSM_INT_EN_RTC_INT_EN_MASK)
 ...
 *  0b10..Issue an interrupt when RTC has rolled over.
 */
#define BBNSM_BBNSM_INT_EN_TA_INT_EN(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_INT_EN_TA_INT_EN_SHIFT)) & BBNSM_BBNSM_INT_EN_TA_INT_EN_MASK)
/*! @} */
 ...
 */
#define BBNSM_BBNSM_EVENTS_RTC_ROLL(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_EVENTS_RTC_ROLL_SHIFT)) & BBNSM_BBNSM_EVENTS_RTC_ROLL_MASK)
 ...
 */
#define BBNSM_BBNSM_EVENTS_TA(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_EVENTS_TA_SHIFT)) & BBNSM_BBNSM_EVENTS_TA_MASK)
 ...
 */
#define BBNSM_BBNSM_EVENTS_EMG_OFF(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_EVENTS_EMG_OFF_SHIFT)) & BBNSM_BBNSM_EVENTS_EMG_OFF_MASK)

#define BBNSM_BBNSM_EVENTS_PWR_OFF_MASK  (0x20U)
#define BBNSM_BBNSM_EVENTS_PWR_OFF_SHIFT (5U)
/*! PWR_OFF - Set Power Off Event
 *  0b0..The set_pwr_off_irq interrupt has not been requested.
 *  0b1..The set_pwr_off_irq interrupt has been requested.
 */
#define BBNSM_BBNSM_EVENTS_PWR_OFF(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_EVENTS_PWR_OFF_SHIFT)) & BBNSM_BBNSM_EVENTS_PWR_OFF_MASK)

#define BBNSM_BBNSM_EVENTS_PWR_ON_MASK  (0x40U)
#define BBNSM_BBNSM_EVENTS_PWR_ON_SHIFT (6U)
/*! PWR_ON - Set Power On Event
 *  0b0..The set_pwr_on_irq interrupt has not been requested.
 *  0b1..The set_pwr_on_irq interrupt has been requested.
 */
#define BBNSM_BBNSM_EVENTS_PWR_ON(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_EVENTS_PWR_ON_SHIFT)) & BBNSM_BBNSM_EVENTS_PWR_ON_MASK)
 ...
 *  0b1..BTN pressed
 */
#define BBNSM_BBNSM_EVENTS_BTN(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_EVENTS_BTN_SHIFT)) & BBNSM_BBNSM_EVENTS_BTN_MASK)
/*! @} */
 ...
 *  0b0..SoC specified pad control data.
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL0(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL0_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL0_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL1(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL1_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL1_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL2(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL2_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL2_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL3(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL3_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL3_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL4(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL4_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL4_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL5(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL5_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL5_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL6(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL6_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL6_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL7(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL7_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL7_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL8(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL8_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL8_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL9(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL9_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL9_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL10(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL10_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL10_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL11(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL11_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL11_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL12(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL12_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL12_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL13(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL13_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL13_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL14(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL14_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL14_MASK)
 ...
 *  0b1..SoC specified pad control data.
 */
#define BBNSM_BBNSM_PAD_CTRL_PAD_CTRL15(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_PAD_CTRL_PAD_CTRL15_SHIFT)) & BBNSM_BBNSM_PAD_CTRL_PAD_CTRL15_MASK)
/*! @} */
 ...
 */
#define BBNSM_BBNSM_RTC_LS_RTC(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_RTC_LS_RTC_SHIFT)) & BBNSM_BBNSM_RTC_LS_RTC_MASK)
/*! @} */
...
/*! RTC - Real-Time Counter
 */
#define BBNSM_BBNSM_RTC_MS_RTC(x) \
    (((uint32_t)(((uint32_t)(x)) << BBNSM_BBNSM_RTC_MS_RTC_SHIFT)) & BBNSM_BBNSM_RTC_MS_RTC_MASK)
/*! @} */
...
#define BBNSM_BASE_ADDRS \
    {                    \
        BBNSM_BASE       \
    }
/** Array initializer of BBNSM peripheral base pointers */
#define BBNSM_BASE_PTRS \
    {                   \
        BBNSM           \
    }
/** Array initializer of BBNSM peripheral base addresses */
#define BBNSM_BASE_ADDRS_NS \
    {                       \
        BBNSM_BASE_NS       \
    }
/** Array initializer of BBNSM peripheral base pointers */
#define BBNSM_BASE_PTRS_NS \
    {                      \
        BBNSM_NS           \
    }
#else
...
#endif  /* #if !defined(MIMX95_BBNSM_H_) */
