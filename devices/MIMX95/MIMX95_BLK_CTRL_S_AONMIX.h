...
typedef struct {
  ...
  __IO uint32_t LP_HANDSHAKE_SENTINEL;             /**< Low Power Handshake for Sentinel Register, offset: 0x138 */
  __IO uint32_t LP_HANDSHAKE2_SENTINEL;            /**< Low Power Handshake 2 for Sentinel Register, offset: 0x13C */
  __IO uint32_t LP_HANDSHAKE3_SENTINEL;            /**< Low Power Handshake 3 for Sentinel Register, offset: 0x140 */
  ...
  __I  uint32_t SENTINEL_RST_REQ_STAT;             /**< Sentinel reset request status, offset: 0x1CC */
  __I  uint32_t SENTINEL_IRQ_REQ_STAT;             /**< Sentinel IRQ request status, offset: 0x1D0 */
...
/*! @name LP_HANDSHAKE_SENTINEL - Low Power Handshake for Sentinel Register */
/*! @{ */

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_MASK (0x2U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_SHIFT (1U)
/*! aonmix - AON domain cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M33_PLATFORM_MASK (0x4U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M33_PLATFORM_SHIFT (2U)
/*! M33_platform - CM33 platform cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M33_PLATFORM(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M33_PLATFORM_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M33_PLATFORM_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_SENTINEL_MASK (0x8U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_SENTINEL_SHIFT (3U)
/*! Sentinel - Sentinel cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_SENTINEL(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_SENTINEL_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_SENTINEL_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_CAMERAMIX_MASK (0x20U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_CAMERAMIX_SHIFT (5U)
/*! Cameramix - Camera domain cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_CAMERAMIX(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_CAMERAMIX_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_CAMERAMIX_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU0_MASK (0x80U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU0_SHIFT (7U)
/*! A55_cpu0 - CA55_CPU0 cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU0(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU0_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU0_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU1_MASK (0x100U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU1_SHIFT (8U)
/*! A55_cpu1 - CA55_CPU1 cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU1(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU1_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU1_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU2_MASK (0x200U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU2_SHIFT (9U)
/*! A55_cpu2 - CA55_CPU2 cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU2(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU2_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU2_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU3_MASK (0x400U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU3_SHIFT (10U)
/*! A55_cpu3 - CA55_CPU3 cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU3(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU3_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU3_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU4_MASK (0x800U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU4_SHIFT (11U)
/*! A55_cpu4 - CA55_CPU4 cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU4(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU4_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU4_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU5_MASK (0x1000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU5_SHIFT (12U)
/*! A55_cpu5 - CA55_CPU5 cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU5(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU5_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_CPU5_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_PLATFORM_MASK (0x2000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_PLATFORM_SHIFT (13U)
/*! A55_platform - CA55_Platform cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_PLATFORM(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_PLATFORM_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_A55_PLATFORM_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDRMIX_TOP_MASK (0x4000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDRMIX_TOP_SHIFT (14U)
/*! ddrmix_top - DDR domain cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDRMIX_TOP(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDRMIX_TOP_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDRMIX_TOP_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDR_PHY_MASK (0x8000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDR_PHY_SHIFT (15U)
/*! ddr_phy - DDR PHY cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDR_PHY(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDR_PHY_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DDR_PHY_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DISPLAY_MASK (0x10000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DISPLAY_SHIFT (16U)
/*! display - Display domain cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DISPLAY(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DISPLAY_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_DISPLAY_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_GPU_MASK (0x20000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_GPU_SHIFT (17U)
/*! gpu - GPU domain cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_GPU(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_GPU_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_GPU_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_TOP_MASK (0x40000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_TOP_SHIFT (18U)
/*! hsio_top - HSIO domain cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_TOP(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_TOP_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_TOP_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_AON_MASK (0x80000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_AON_SHIFT (19U)
/*! hsio_aon - HSIO_AON cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_AON(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_AON_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_HSIO_AON_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M7MIX_MASK (0x100000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M7MIX_SHIFT (20U)
/*! m7mix - M7 domain cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M7MIX(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M7MIX_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_M7MIX_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NETC_MASK (0x200000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NETC_SHIFT (21U)
/*! netc - NETC domain cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NETC(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NETC_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NETC_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NOC_MASK (0x400000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NOC_SHIFT (22U)
/*! noc - NOC cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NOC(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NOC_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NOC_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NPU_MASK (0x800000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NPU_SHIFT (23U)
/*! npu - NPU cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NPU(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NPU_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_NPU_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_VPU_MASK (0x1000000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_VPU_SHIFT (24U)
/*! vpu - VPU cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_VPU(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_VPU_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_VPU_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_TOP_MASK (0x2000000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_TOP_SHIFT (25U)
/*! wakeupmix_top - wakeupmix_top cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_TOP(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_TOP_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_TOP_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_JTAG_MASK (0x4000000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_JTAG_SHIFT (26U)
/*! wakeupmix_jtag - wakeupmix_jtag cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_JTAG(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_JTAG_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_JTAG_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG_3_4_MASK (0x8000000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG_3_4_SHIFT (27U)
/*! wakeupmix_wdog_3_4 - wakeupmix_wdog_3_4 cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG_3_4(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG_3_4_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG_3_4_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG5_MASK (0x10000000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG5_SHIFT (28U)
/*! wakeupmix_wdog5 - wakeupmix_wdog5 cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG5(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG5_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_WAKEUPMIX_WDOG5_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_POWER_MASK (0x40000000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_POWER_SHIFT (30U)
/*! aonmix_power - AON domain low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_POWER(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_POWER_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SENTINEL_AONMIX_POWER_MASK)
/*! @} */

/*! @name LP_HANDSHAKE2_SENTINEL - Low Power Handshake 2 for Sentinel Register */
/*! @{ */

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_CAMERAMIX_MASK (0x1U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_CAMERAMIX_SHIFT (0U)
/*! cameramix - Camera domain low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_CAMERAMIX(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_CAMERAMIX_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_CAMERAMIX_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU0_MASK (0x4U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU0_SHIFT (2U)
/*! A55_cpu0 - CA55_CPU0 low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU0(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU0_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU0_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU1_MASK (0x8U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU1_SHIFT (3U)
/*! A55_cpu1 - CA55_CPU1 low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU1(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU1_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU1_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU2_MASK (0x10U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU2_SHIFT (4U)
/*! A55_cpu2 - CA55_CPU2 low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU2(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU2_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU2_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU3_MASK (0x20U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU3_SHIFT (5U)
/*! A55_cpu3 - CA55_CPU3 low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU3(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU3_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU3_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU4_MASK (0x40U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU4_SHIFT (6U)
/*! A55_cpu4 - CA55_CPU4 low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU4(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU4_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU4_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU5_MASK (0x80U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU5_SHIFT (7U)
/*! A55_cpu5 - CA55_CPU5 low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU5(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU5_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_CPU5_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_PLATFORM_MASK (0x100U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_PLATFORM_SHIFT (8U)
/*! A55_platform - CA55_Platform low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_PLATFORM(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_PLATFORM_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_A55_PLATFORM_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DDR_MASK (0x200U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DDR_SHIFT (9U)
/*! ddr - DDR domain low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DDR(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DDR_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DDR_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DISPLAY_MASK (0x400U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DISPLAY_SHIFT (10U)
/*! display - Display domain low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DISPLAY(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DISPLAY_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_DISPLAY_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_GPU_MASK (0x800U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_GPU_SHIFT (11U)
/*! gpu - GPU domain low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_GPU(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_GPU_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_GPU_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_TOP_MASK (0x1000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_TOP_SHIFT (12U)
/*! hsio_top - HSIO domain low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_TOP(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_TOP_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_TOP_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_AON_MASK (0x2000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_AON_SHIFT (13U)
/*! hsio_aon - HSIO_AON low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_AON(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_AON_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_HSIO_AON_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_M7_PLATFORM_MASK (0x4000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_M7_PLATFORM_SHIFT (14U)
/*! m7_platform - M7 Platform low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_M7_PLATFORM(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_M7_PLATFORM_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_M7_PLATFORM_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NETC_MASK (0x8000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NETC_SHIFT (15U)
/*! netc - NETC domain low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NETC(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NETC_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NETC_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NOC_MASK (0x10000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NOC_SHIFT (16U)
/*! noc - NOC low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NOC(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NOC_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NOC_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NPU_MASK (0x20000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NPU_SHIFT (17U)
/*! npu - NPU low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NPU(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NPU_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_NPU_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_VPU_MASK (0x40000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_VPU_SHIFT (18U)
/*! vpu - VPU low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_VPU(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_VPU_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_VPU_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_WAKEUP_MASK (0x80000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_WAKEUP_SHIFT (19U)
/*! wakeup - WAKEUP low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_WAKEUP(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_WAKEUP_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_WAKEUP_MASK)

#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_OSC24MHZ_MASK (0x100000U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_OSC24MHZ_SHIFT (20U)
/*! osc24mhz - OSC 24MHz low power handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_OSC24MHZ(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_OSC24MHZ_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE2_SENTINEL_OSC24MHZ_MASK)
/*! @} */
...
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SM_SENTINEL_MASK (0x8U)
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SM_SENTINEL_SHIFT (3U)
/*! Sentinel - Sentinel cold reset handshake enable
 *  0b1..Enable
 *  0b0..Disable
 */
#define BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SM_SENTINEL(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SM_SENTINEL_SHIFT)) & BLK_CTRL_S_AONMIX_LP_HANDSHAKE_SM_SENTINEL_MASK)
...
/*! @name SENTINEL_RST_REQ_STAT - Sentinel reset request status */
/*! @{ */
...
/*! @name SENTINEL_IRQ_REQ_STAT - Sentinel IRQ request status */
/*! @{ */
