 ...
 * @version
 * @date
 * @brief CMSIS Peripheral Access Layer for MIMX952_GICR
 *
 * CMSIS Peripheral Access Layer for MIMX952
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX952_GICR_H_)  /* Check if memory map has not been already included */
#define MIMX952_GICR_H_
...
#endif  /* #if !defined(MIMX952_GICR_H_) */
