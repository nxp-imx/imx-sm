...
#define GPC_CPU_CTRL_CMC_IRQ_WAKEUP_MASK_ARRAY_COUNT       13u
#define GPC_CPU_CTRL_CMC_IRQ_WAKEUP_STAT_ARRAY_COUNT       13u
...
#define GPC_CPU_CTRL_CMC_IRQ_WAKEUP_MASK_COUNT            (13U)
...
#define GPC_CPU_CTRL_CMC_IRQ_WAKEUP_STAT_COUNT            (13U)
 ...
 *  0b1..This step is disabled. GPC_CPU_CTRL will skip this step and not send any request.
 */
...
/*! PRETEND_SLEEP - Write 1 to force CMC into sleep. Used to debug GPC_CPU_CTRL status. Locked by LOCK_CFG field. */
