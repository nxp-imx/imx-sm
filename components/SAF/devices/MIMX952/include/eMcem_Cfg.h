 ...
 */
#define EMCEM_FAULT_MASK_ARRAY_SIZE     (5U)
/** @} */
...
/*!
 * @brief    Array for masking out of the VFCCU(100 faults), EIM(35 error injection channels), SRAMC(1 error injection channel)
