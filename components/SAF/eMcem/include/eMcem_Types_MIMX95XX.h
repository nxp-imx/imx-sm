...
*                                      DEFINES AND MACROS
==================================================================================================*/
/* Fault status register counts per VFCCU instance */
#define EMCEM_VFCCU_FAULT_STATUS_REG_COUNT      (3U)

/* Fault line offsets per VFCCU instance */
#define EMCEM_VFCCU_FAULT_LINE_OFFSET           (EMCEM_FCCU_FLT_TEMP_HIGH)

/* SW fault line offsets per VFCCU instance */
...
/* Error container size - total number of fault status registers for all VFCCUs */
#define EMCEM_VFCCU_ERROR_CONTAINER_SIZE        ( ( ( EMCEM_CVFCCU_FAULT_LINES_COUNT - 1U ) / 32U ) + 1U )

/* Width of FCCU registers (bits), and corresponding shift and mask */
...
==================================================================================================*/
/* An array containing unified faults reported by VFCCU */
